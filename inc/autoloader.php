 ...
 * plugin.
 *
 * @package caex_woocommerce\Inc
 */

spl_autoload_register( 'caex_woocommerce_autoload' );

/**
 * Dynamically loads the class attempting to be instantiated elsewhere in the
 * plugin by looking at the $class_name parameter being passed as an argument.
 *
 * The argument should be in the form: caex_woocommerce\Namespace. The
 ...
 */
function caex_woocommerce_autoload( $class_name ) {

    // If the specified $class_name does not include our namespace, duck out.
    if ( false === strpos( $class_name, 'caex_woocommerce' ) ) {
        return;
    }
